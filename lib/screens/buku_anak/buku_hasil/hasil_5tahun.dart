...
class hasil_5Tahun extends StatefulWidget {
  hasil_5Tahun({super.key});

  @override
  State<hasil_5Tahun> createState() => _hasil_5TahunState();
}

class _hasil_5TahunState extends State<hasil_5Tahun> {
    ...
    try {
      ...
      if (user != null) {
        ...
        QuerySnapshot userAnswersQuery = await dataCollection
            ...
            .where('formTitle', isEqualTo: 'Usia 60 - 72 Bulan')
            .get();
        ...
        print('Document with title "Usia 60 - 72 Bulan" not found');
        return [];
      }
    } catch (e) {
