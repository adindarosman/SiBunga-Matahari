...
class hasil_6Bulan extends StatefulWidget {
  @override
  _hasil_6BulanState createState() => _hasil_6BulanState();
}

class _hasil_6BulanState extends State<hasil_6Bulan> {
    ...
    try {
      ...
      if (user != null) {
        ...
        QuerySnapshot userAnswersQuery = await dataCollection
            ...
            .where('formTitle', isEqualTo: 'Usia 3 - 6 Bulan')
            .get();
        ...
        print('Document with title "Usia 3 - 6 Bulan" not found');
        return [];
      }
    } catch (e) {
