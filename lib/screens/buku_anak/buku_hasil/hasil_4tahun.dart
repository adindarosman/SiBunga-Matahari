...
class hasil_4Tahun extends StatefulWidget {
  hasil_4Tahun({super.key});

  @override
  State<hasil_4Tahun> createState() => _hasil_4TahunState();
}

class _hasil_4TahunState extends State<hasil_4Tahun> {
    ...
    try {
      ...
      if (user != null) {
        ...
        QuerySnapshot userAnswersQuery = await dataCollection
            ...
            .where('formTitle', isEqualTo: 'Usia 48 - 60 Bulan')
            .get();
        ...
        print('Document with title "Usia 48 - 60 Bulan" not found');
        return [];
      }
    } catch (e) {
