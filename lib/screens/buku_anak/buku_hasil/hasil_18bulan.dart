...
class hasil_18Bulan extends StatefulWidget {
  hasil_18Bulan({super.key});

  @override
  State<hasil_18Bulan> createState() => _hasil_18BulanState();
}

class _hasil_18BulanState extends State<hasil_18Bulan> {
    ...
    try {
      ...
      if (user != null) {
        ...
        QuerySnapshot userAnswersQuery = await dataCollection
            ...
            .where('formTitle', isEqualTo: 'Usia 12 - 18 Bulan')
            .get();
        ...
        print('Document with title "Usia 12 - 18 Bulan" not found');
        return [];
      }
    } catch (e) {
