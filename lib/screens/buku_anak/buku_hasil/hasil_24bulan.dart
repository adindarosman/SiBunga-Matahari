...
class hasil_24Bulan extends StatefulWidget {
  hasil_24Bulan({super.key});

  @override
  State<hasil_24Bulan> createState() => _hasil_24BulanState();
}

class _hasil_24BulanState extends State<hasil_24Bulan> {
    ...
    try {
      ...
      if (user != null) {
        ...
        QuerySnapshot userAnswersQuery = await dataCollection
            ...
            .where('formTitle', isEqualTo: 'Usia 18 - 24 Bulan')
            .get();
        ...
        print('Document with title "Usia 18 - 24 Bulan" not found');
        return [];
      }
    } catch (e) {
