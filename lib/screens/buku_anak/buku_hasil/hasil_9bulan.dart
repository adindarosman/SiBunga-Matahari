...
class hasil_9Bulan extends StatefulWidget {
  hasil_9Bulan({super.key});

  @override
  State<hasil_9Bulan> createState() => _hasil_9BulanState();
}

class _hasil_9BulanState extends State<hasil_9Bulan> {
    ...
    try {
      ...
      if (user != null) {
        ...
        QuerySnapshot userAnswersQuery = await dataCollection
            ...
            .where('formTitle', isEqualTo: 'Usia 6 - 9 Bulan')
            .get();
        ...
        print('Document with title "Usia 6 - 9 Bulan" not found');
        return [];
      }
    } catch (e) {
