...
import 'package:SiBunga/screens/dashboard/widgets/storage_chart/tinggi_usia_chart.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';

class TinggiUsia_details extends StatefulWidget {
  ...
  @override
  State<TinggiUsia_details> createState() => _TinggiUsia_detailsState();
}

class _TinggiUsia_detailsState extends State<TinggiUsia_details> {
  ...
  List<DataRow> get tableRows {
    return dataPertumbuhanList.map((data) {
      // Convert String to double for tinggiBadan
      ...
      return DataRow(cells: [
        ...
        DataCell(Text(tinggiBadan.toString())),
