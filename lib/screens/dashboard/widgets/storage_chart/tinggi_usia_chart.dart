...
class TinggiChart extends StatefulWidget {
  @override
  State<TinggiChart> createState() => _TinggiChartState();
}

class _TinggiChartState extends State<TinggiChart> {
  ...
  Widget build(BuildContext context) {
    ...
    List<FlSpot> spots = dataPertumbuhanList.map((data) {
      ...
      return FlSpot(ageInMonths, tinggiBadan);
    }).toList();
