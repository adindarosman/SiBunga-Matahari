...
class LenganUsia extends StatefulWidget {
  @override
  State<LenganUsia> createState() => _LenganUsiaState();
}

class _LenganUsiaState extends State<LenganUsia> {
  ...
  Widget build(BuildContext context) {
    ...
    List<FlSpot> spots = dataPertumbuhanList.map((data) {
      ...
      return FlSpot(ageInMonths, lingkarLgn);
    }).toList();
